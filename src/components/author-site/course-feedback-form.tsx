...
// Mirrors BookFeedbackForm exactly, adapted for courses.
export function CourseFeedbackForm({ courseSlug, domain, accentColor }: CourseFeedbackFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/public/courses/${courseSlug}/feedback`, {
        method: "POST",
