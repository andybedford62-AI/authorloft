...
export const LANDING_PAGES: Record<string, LandingPageData> = {
  ...
  "author-media-kit": {
    ...
    faqs: [
      ...
      { q: "Which plan includes the media kit?", a: "The media kit is available on the Premium plan ($79.99/month). It's designed for authors who are actively pursuing media coverage and speaking opportunities." },
