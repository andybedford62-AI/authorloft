...
export const LANDING_PAGES: Record<string, LandingPageData> = {
  ...
  "author-media-kit": {
    ...
    faqs: [
      ...
      { q: "Which plan includes the media kit?", a: "The media kit is available on the Premium plan ($39.99/month). It's designed for authors who are actively pursuing media coverage and speaking opportunities." },
  ...
  "reader-analytics-for-authors": {
    ...
    faqs: [
      ...
      { q: "Which plan includes analytics?", a: "Reader analytics are available on Standard ($9.99/month) and Premium ($39.99/month) plans. The Free plan does not include analytics." },
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "AI Social Promote writes posts for New Releases, Track Spotlights, Behind the Music, and Ask Listeners (Standard and Premium)",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Analytics show where listeners come from and which pages they visit (Standard and Premium)",
          "Contact form for bookings, collaborations, and press",
          "Music genre themes on every plan, plus your own domain on Standard and Premium",
        ],
      },
    ],
    faqs: [
      ...
      { q: "Which plan includes music?", a: "Every plan, including Free, with the music player, share links, and music genre themes. Standard and Premium add more lists and tracks, AI Social Promote posts, a custom domain, and the analytics dashboard. The plan cards above show the exact limits." },
