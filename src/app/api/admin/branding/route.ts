...
export async function PATCH(req: NextRequest) {
  ...
  const author = await prisma.author.update({
    ...
    data: {
      ...
      ...(supportUrl   !== undefined && { supportUrl:   supportUrl   || null }),
      ...(contactEmail        !== undefined && { contactEmail:        contactEmail        || null }),
      ...(contactResponseTime !== undefined && { contactResponseTime: contactResponseTime || null }),
      ...(contactOpenTo       !== undefined && { contactOpenTo:       contactOpenTo       || null }),
