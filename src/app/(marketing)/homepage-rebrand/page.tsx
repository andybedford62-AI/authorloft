...
import { RebelHero } from "./rebrand-hero";
import { AnimatedStatsBar, JourneySection, IntegrationStrip, AISpotlight, RebelCTA } from "./animated-sections";
...
export const metadata: Metadata = {
  ...
  robots: { index: false }, // preview page — don't index
};
