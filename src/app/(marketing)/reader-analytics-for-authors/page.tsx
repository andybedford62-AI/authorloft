...
const data = LANDING_PAGES["reader-analytics-for-authors"];
...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: data.metaTitle, description: data.metaDescription, images: [DEFAULT_OG_IMAGE] },
};
