    ...
    <div>
      ...
      >
        ...
        {editing ? (
          ...
          <div className="flex items-center gap-1 ml-2">
            <IconButton icon={<Pencil className="h-4 w-4" />} title="Edit" variant="primary" onClick={() => { setEditing(true); setEditName(genre.name); }} />
            <IconButton icon={<Plus className="h-4 w-4" />} title="Add sub-genre" variant="primary" onClick={() => onAddChild(genre.id, genre.name)} />
