...
export async function GET() {
  ...
  const lines: string[] = [
    ...
    "## Features & Pricing",
    "",
    `- [Features](${BASE}/features): Full feature list across Free, Standard ($39.99/mo), and Premium ($79.99/mo) plans — book catalog, direct sales, custom domain, flip book previews, AI writing tools, and reader analytics.`,
