  ...
  return (
    <div>
      <PageBanner
        label="Learn"
        title="Courses"
        subtitle={`Online courses and workshops from ${author.displayName || author.name}.`}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        {courses.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-semibold text-gray-500">No courses available</h2>
            <p className="text-gray-400 mt-2 mb-8 max-w-sm mx-auto">
              Check back soon — courses and workshops may appear here.
            </p>
            <Link href="/books">
